 ...
 *
 * taken from: https://github.com/googlesamples/androidtv-Leanback/blob/master/app/src/main/java/com/google/android/exoplayer2/ext/leanback/LeanbackPlayerAdapter.java
 */
...
public final class LeanbackPlayerAdapter extends PlayerAdapter {
     ...
     * {@link SimpleExoPlayer} instance. The caller remains responsible for releasing the player
    ...
    public LeanbackPlayerAdapter(
            Context context, SimpleExoPlayer player, final int updatePeriodMs) {
    ...
    private final class ComponentListener
            implements Player.EventListener, SimpleExoPlayer.VideoListener, SurfaceHolder.Callback {
        ...
        public void onPlayerError(ExoPlaybackException exception) {
            ...
            if (errorMessageProvider != null) {
                ...
                callback.onError(
                        LeanbackPlayerAdapter.this, errorMessage.first, errorMessage.second);
            } else {
                callback.onError(
                        LeanbackPlayerAdapter.this,
                        exception.type,
                        context.getString(
                                R.string.lb_media_player_error,
                                exception.type,
