...
public class EventCardPresenter extends Presenter {
    ...
    private class EventCardPresenterViewHolder extends AbstractBaseCardViewHolder {
        ...
        private Drawable resolveImage(Context context, EventCardItem cardItem) throws IOException {
            ...
            Bitmap image = picasso.load(cardItem.getMainImageUrl()).resize(320, 240).get();
            ...
            Bitmap homeTeam = picasso.load(cardItem.getHomeTeamImageUrl()).resize(100, 100).get();
            Bitmap awayTeam = picasso.load(cardItem.getAwayTeamImageUrl()).resize(100, 100).get();
